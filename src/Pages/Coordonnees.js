...
export default function Coordonnees(){
    ...
    return(<>
        ...
        <div>
            ...
            <p className="boldText contactme">N'hesitez pas a me contacter si mon profil vous interesse ou si vous avez des suggestions</p>
            <div className="data_container">
                ...
                <div className="contactContainer">
                    <Icon icon="ci:mail" className="dataIcon" color="black" width="30" height="30" />
                ...
                <div className="contactContainer">
                    <Icon icon="akar-icons:linkedin-box-fill" className="dataIcon" color="black" width="30" height="30" />
                ...
                <div className="contactContainer">
                    <Icon icon="akar-icons:github-fill" className="dataIcon" color="black" width="30" height="30" />
